...
file_name = 'output/daum_movie_review(generator).txt'
...
def _parse_review_generator(review_list):
    try :
        for review in review_list :
            yield {'author': review.select('a em[class=link_profile]')[0].text,
        ...
        print('err : _parse_review_generator')
